...
public class PlanterRecipeCategory implements IRecipeCategory<PlanterRecipe> {
    public static final Identifier UID = Identifier.fromNamespaceAndPath("agritech", "planter");
    public static final Identifier TEXTURE = Identifier.fromNamespaceAndPath("agritech", "textures/gui/jei/jei_planters_gui.png");
    ...
    public PlanterRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.icon = guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ATBlocks.OAK_PLANTER));
    }
